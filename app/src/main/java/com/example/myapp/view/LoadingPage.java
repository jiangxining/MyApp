...
public class LoadingPage extends ConstraintLayout {
    ...
    private void initView(){
        ...
        mLoadingLayout = findViewById(com.example.myapp.R.id.loading_layout);
        mErrorGroup = findViewById(com.example.myapp.R.id.loading_group_error);
        mGifView = findViewById(com.example.myapp.R.id.loading_gif_view);
        mTVMsg = findViewById(com.example.myapp.R.id.loading_tv_msg);
        mReload = findViewById(com.example.myapp.R.id.loading_btn_reload);
